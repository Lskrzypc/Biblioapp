      ...
      <ol className="bg-main-project px-4 py-2 rounded-lg flex space-x-2 sm:space-x-4">
        {items.map((item, index) => (
          <li key={index} className="flex items-center">
            ...
            {index !== items.length - 1 && (
              <svg
                className="mx-1 h-4 w-4 text-black-project"
                fill="currentColor"
                viewBox="0 0 20 20"
              ...
              >
                <path
                  fillRule="evenodd"
                  d="M12.293 5.293a1 1 0 011.414 0l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414-1.414L14.586 11H5a1 1 0 110-2h9.586l-1.293-1.293a1 1 0 010-1.414z"
                  clipRule="evenodd"
                />
              </svg>
            )}
